...
namespace TubeStar
{
    ...
    public partial class TitlePage : UserControl
    {
        ...
        {
            Settings.CustomYouTubeApiKey = txtApiKey.Text.Trim();
            CustomMessageBox.ShowDialog(
                "Chave Salva! / Key Saved!", 
                "Sua chave de API do YouTube foi salva localmente com sucesso! / Your YouTube API key has been successfully saved locally!", 
