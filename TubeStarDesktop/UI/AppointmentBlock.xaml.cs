    ...
    public partial class AppointmentBlock : UserControl
    {
        ...
        public Task Task
        {
            ...
            set
            {
                ...
                txtTime.Foreground = appointmentTextBlock.Foreground = isNull ? Brushes.Gray : Brushes.WhiteSmoke;
            }
        }
        ...
        {
            this.Background = new SolidColorBrush((Color)ColorConverter.ConvertFromString("#252525"));
        }
